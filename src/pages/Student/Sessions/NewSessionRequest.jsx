        ...
        <div className="TablePageHeader ">
          <div className="info-content-header d-flex align-items-center justify-content-between gap-3 flex-wrap w-100">
            <div className="d-flex align-items-center name ">
              ...
              <div style={{ color: "#7E8799" }}> طلب جلسة جديدة </div>
            </div>
            <div
              className="updateBtn"
              onClick={() => router("/student/Sessions")}
            >
          ...
          <form onSubmit={formik.handleSubmit} className="row">
            <div className="col-lg-6 col-md-12">
              <div className="CustomFormControl">
                <label htmlFor="role">الاكاديمية التعليمية</label>
                <Select
                  options={options}
            ...
            <div className="col-lg-6 col-md-12">
              <div className="CustomFormControl">
                <label htmlFor="role">المدرب </label>
                <Select
                  options={options}
                  placeholder={formik.values.role}
                  styles={customStyles}
            ...
            <div className="col-lg-6 col-md-12">
              <div className="CustomFormControl">
                <label htmlFor="name"> موعد البث</label>
            ...
            <div className="col-lg-6 col-md-12">
              <div className="CustomFormControl">
                <label htmlFor="name"> وقت الجلسة</label>
                <DatePicker style={{ width: "100%" }} format="MM/dd/yyyy" />
                {formik.touched.name && formik.errors.name && (
                  <div>{formik.errors.name}</div>
                )}
