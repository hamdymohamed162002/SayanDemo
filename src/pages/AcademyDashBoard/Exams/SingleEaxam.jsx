    ...
    <div className="all-info-top-header main-info-top">
            ...
            <div className="userTabs">
              <ul className="flex-wrap gap-3">
                <NavLink
                  to={
                    academy
                      ? "/academy/SingleExam/exam"
                      : "/admin/SingleExam/exam"
                  }
                  className={({ isActive }) => {
                ...
                <NavLink
                  to={
                    academy
                      ? "/academy/SingleExam/StudentTry"
                      : "/admin/SingleExam/StudentTry"
                  }
                  className={({ isActive }) => {
                    return isActive ? " tablePage active" : "tablePage";
                  }}
      ...
      <div className={classes.mainCard}>
        <Routes>
          <Route
            path={"/exam"}
            element={<SingleExamComponent academy classes={classes} />}
          />
