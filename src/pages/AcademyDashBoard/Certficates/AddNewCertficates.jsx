...
const AcademyAddNewCertficates = () => {
        ...
        <div className="HeaderContainer">
          <div className="info-content-header d-flex align-items-center justify-content-between gap-3 flex-wrap w-100">
            <div className="d-flex align-items-center name ">
              ...
              <div style={{ color: "#7E8799" }}> اضافة شهادة جديدة</div>
            </div>
            <Link to={"/academy/Certficates"} className="updateBtn">
      ...
      <div className="CustomCard formCard all-add-notific pb-4 pt-4">
        <form onSubmit={formik.handleSubmit} className="row">
          <div className=" justify-content-center">
            <div className=" row g-3 m-auto button-content--1 justify-content-center">
              <img
                src={
                  formik.values.file
          ...
          <div className="col-lg-6 col-md-12">
            <div className="CustomFormControl">
              <label htmlFor="name">عنوان الشهادة </label>
              <input
                type="text"
...
export default AcademyAddNewCertficates;
