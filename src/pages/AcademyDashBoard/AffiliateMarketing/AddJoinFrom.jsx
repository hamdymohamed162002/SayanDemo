...
import SingleSelectBox from "../../../component/UI/SingleSelectBox/SingleSelectBox";
const customStyles = {
...
const AddJoinFrom = () => {
  ...
  return (
    <div className="mb-5 add-join all-info-top-header main-info-top">
        ...
        <div className="d-flex align-items-center name ">
         <div className="info-content-header d-flex align-items-center justify-content-between gap-3 flex-wrap w-100">
           ...
           <div  style={{ color: "#7E8799" }}>
             ارسال دعوة انضمام للتسويق بالعمولة{" "}
           </div>
         </div>
        </div>
        <Link to="/academy/AffiliateMarketing" className="updateBtn">
      ...
      <div className="CustomCard formCard all-add-notific pb-4 pt-4">
        <form onSubmit={formik.handleSubmit} className="row">
          ...
          <div className="col-lg-6 col-md-12">
            <SingleSelectBox label={"عدد المدعوين"} />
          </div>

          <div className="col-lg-12 col-md-12 mt-3">
            <div className="CustomFormControl">
              <label htmlFor="name">رسالة الدعوة </label>
              <textarea
                type="text"
                id="name"
                name="name"
          ...
          <div className="col-lg-6 col-md-12">
            <SingleSelectBox label={" المدعوين"} />
          </div>
