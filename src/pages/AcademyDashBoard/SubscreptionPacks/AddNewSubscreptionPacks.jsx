...
const AddNewSubscreptionPacksAcademy = () => {
    ...
    <div className="mb-5 all-info-top-header main-info-top">
      <div className="TablePageHeader ">
        <div className="info-content-header d-flex align-items-center justify-content-between gap-3 flex-wrap w-100">
          <div className="d-flex align-items-center name ">
            ...
            <div style={{ color: "#7E8799" }}>انشاء باقة اشتراك جديدة </div>
          </div>
      ...
      <div className="CustomCard formCard all-add-notific pb-4 pt-4">
        <form onSubmit={formik.handleSubmit} className="row g-3">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="CustomFormControl">
              <label htmlFor="role">المدة </label>
              <Select
                options={options}
          ...
          <div className="col-lg-6 col-md-12">
            <div className="CustomFormControl">
              <label htmlFor="role">العروض </label>
              <Select
                options={options}
                placeholder={formik.values.role}
                styles={customStyles}
          ...
          <div className="col-lg-12 col-md-12">
            <div className="CustomFormControl">
              <label htmlFor="name"> المزايا</label>
              <textarea
                type="text"
                id="name"
                name="name"
...
export default AddNewSubscreptionPacksAcademy;
